...
{
    public class GetAllRewardRulesQueryHandler : IRequestHandler<GetAllRewardRulesQueryRequest, GetAllRewardRulesQueryResponse>
    {
        private readonly IRewardRuleReadRepository _rewardRuleReadRepository;

        public GetAllRewardRulesQueryHandler(IRewardRuleReadRepository rewardRuleReadRepository)
        {
            _rewardRuleReadRepository = rewardRuleReadRepository;
        }

        public async Task<GetAllRewardRulesQueryResponse> Handle(GetAllRewardRulesQueryRequest request, CancellationToken cancellationToken)
        {
            var rules = await _rewardRuleReadRepository.GetAll(false)
            ...
            return new GetAllRewardRulesQueryResponse { Rules = rules };
        }
    }
}
